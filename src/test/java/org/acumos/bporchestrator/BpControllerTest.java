...
public class BpControllerTest extends AbstractControllerTest {
	...
	public void utilityMethodTester() {

		String s1 = "www.acumos.org";
		String s2 = "databroker";
		// testing contactdataBroker

		BlueprintOrchestratorController bpoc = new BlueprintOrchestratorController();
		bpoc.contactdataBroker(s1, s2);
	}
